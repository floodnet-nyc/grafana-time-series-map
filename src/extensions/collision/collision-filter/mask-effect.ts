...
import {joinLayerBounds, getRenderBounds, makeViewport, Bounds} from './projection-utils';
...
type Channel = {
  ...
  bounds: Bounds | null;
  maskBounds: Bounds;
  layerBounds: Array<ReturnType<Layer['getBounds']>>;
  coordinateOrigin: [number, number, number];
  coordinateSystem: CoordinateSystem;
};
  ...
  private _renderChannel(
    ...
    if (maskChanged || viewportChanged) {
      ...
      if (maskChanged || !equals(channelInfo.bounds, oldChannelInfo.bounds)) {
        ...
        maskPass.render({
          pass: 'mask',
          channel: channelInfo.index as 0 | 1 | 2 | 3,
    ...
    this.masks[channelInfo.id] = {
      index: channelInfo.index as 0 | 1 | 2 | 3,
